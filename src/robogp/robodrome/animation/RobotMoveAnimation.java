 ...
 * @author claudia
 */
public class RobotMoveAnimation extends Animation implements Serializable {
  ...
  public RobotMoveAnimation(String robotColor,int move, Direction dir,Rotation rot) {
      
      this();
      this.which=robotColor;
      this.movement = move;
      this.dir = dir;
      this.rotation = rot;
