 ...
 * @author claudia
 */
public class Robodrome implements Serializable {
    ...
    public BoardCell getCell(int row, int col) {
        ...
        if (row < rows && col < columns && row>=0 && row <=11 && col >=0 && col <=15 ) {
    ...
    public boolean setRobot(Direction dir,int row,int col,String color) {
        robot=new Robot(color,dir,row,col);
        robot.creaRegistro();
        return true;
    }
