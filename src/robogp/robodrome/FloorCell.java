 ...
 * @author claudia
 */
public class FloorCell extends BoardCell implements Serializable {
  ...
  private transient BufferedImage res;
  ...
  public BufferedImage getBaseImage() {
    res = ImageUtil.superImpose(null, TileProvider.getTileProvider().getTile("F"));
